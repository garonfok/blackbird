...
export function Arrangers() {
  ...
  return (
    <Command className="flex flex-col gap-[4px]">
      <CommandInput placeholder="Arrangers" />
      <CommandList className="overflow-hidden">
        <CommandEmpty>No arrangers found.</CommandEmpty>
      </CommandList>
              ...
              <CommandItem key={musician.id} asChild>
                ...
                >
                  <input
                    ...
                    checked={filter.arrangers.some((i) => i.id === musician.id)}
                    type="checkbox"
