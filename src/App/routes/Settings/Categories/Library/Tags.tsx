...
import { tagsAdd, tagsDelete, tagsGetAll, tagsUpdate } from "@/invokers/db/tags";
    ...
    <ContentWrapper value="tags" name="Tags">
      <Dialog open={newTagOpen} onOpenChange={setNewTagOpen}>
        <DialogTrigger asChild>
          <Button className="w-fit">New tag</Button>
        </DialogTrigger>
        <DialogContent>
      ...
      <div className="flex flex-col gap-[4px]">
        {tags.map((tag, index) => (
          <Badge
            variant="outline"
            key={tag.id}
            className="w-full group gap-[8px]"
          >
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction asChild>
                      <Button onClick={() => handleClickDeleteTag(tag.id)}>
                        Delete
                      </Button>
                    </AlertDialogAction>
                  </AlertDialogFooter>
